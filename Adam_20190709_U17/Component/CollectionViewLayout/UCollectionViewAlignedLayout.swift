...
public class UCollectionViewAlignedLayout: UICollectionViewFlowLayout {
    ...
    fileprivate func isFrame(for firstItemAttributes: UICollectionViewLayoutAttributes, inSameLineAsFrameFFor secondItemAttributes: UICollectionViewLayoutAttributes) -> Bool {
    ...
    private func verticalAlignmentAxisForLine(with layoutAttributes: [UICollectionViewLayoutAttributes]) -> AlignmentAxis<VerticalAlignment>? {
        ...
        case .top:
            let minY = layoutAttributes.reduce(CGFloat.greatestFiniteMagnitude) { min($0, $1.frame.midY) }
    ...
    fileprivate func verticalAlignmentAxis(for currnetLayoutAttrubutes: UICollectionViewLayoutAttributes) -> AlignmentAxis<VerticalAlignment> {
        let layoutAttributesInLine = layoutAttributes(forItemsInLineWith: currnetLayoutAttrubutes)
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func alignHorizontally(collectionViewLayout: UCollectionViewAlignedLayout) {
        ...
        case .left:
            if isRepresentFirstItemInLine(collectionViewLayout: collectionViewLayout) {
